...
class Check {
     ...
     */
    public static function Image($ImageUrl, $ImageDesc, $ImageW = null, $ImageH = null, $ImageClass = null, $imageAlign = null) {

        self::$Data = $ImageUrl;

        $imgClass = $ImageClass ? 'class="' . $ImageClass . '"' : '';

        $imageAlign = $imageAlign ? '&a=' . $imageAlign : '';

        // if (file_exists(self::$Data) && !is_dir(self::$Data)):
            $imagem = self::$Data;
            return "<img src=\"../tim.php?src={$imagem}&w={$ImageW}&h={$ImageH}{$imageAlign}\" alt=\"{$ImageDesc}\" title=\"{$ImageDesc}\" {$imgClass} />";
        // else:
        //     return false;
        // endif;
    }
